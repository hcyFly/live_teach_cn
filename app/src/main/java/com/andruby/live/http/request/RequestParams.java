...
public class RequestParams implements Serializable {
	 ...
	 * @param name        the name of the stream.
	 * @param contentType the content type of the file, eg. application/json
	 * @param autoClose   btn_close_normal input stream automatically on successful upload
	 */
...
//    }
	...
	/**
	 * Set global flag which determines whether to automatically btn_close_normal input streams on successful
	 * upload.
	 *
	 * @param flag boolean whether to automatically btn_close_normal input streams
	 */
	...
	public PostStringBuilder getPostJsonBuilder() {
		...
		LogUtil.d(LOG_TAG,"post json :"+mGson.toJson(urlParams));
