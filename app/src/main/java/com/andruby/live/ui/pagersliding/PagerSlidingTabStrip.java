...
package com.andruby.live.ui.pagersliding;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public interface OnTextViewclick{
        public void textViewOnclick(int pos);
    }
    // @formatter:off
    ...
    private int layoutUnderLineColor = 0xBCBCBC;
    ...
    private int tabTextSelectedColor = 0x3775A3;
    ...
    private int tabBackgroundResId = R.drawable.pager_tab_bg;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextSelectedColor = getResources().getColor(R.color.btn_blue);
//        othertabTextSelectedColor = getResources().getColor(R.color.ball_circle_text_color);
       /* tabTextSelectedColor = getResources().getColor(R.color.pstrip_text_selected_color_red);
        othertabTextSelectedColor = getResources().getColor(R.color.pstrip_text_selected_color_red);*/
        ...
        final String xmlns="http://schemas.android.com/apk/res/com.zhongsou.souyue";
//        isYaowen=attrs.getAttributeBooleanValue(xmlns, "isyaowen", false);
        //remove yaowen flag
        a.recycle();
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(onTextViewclick!=null){
                    onTextViewclick.textViewOnclick(position);
                }
...
//            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw underline
        rectPaint.setColor(layoutUnderLineColor);
    ...
    public void setLayoutUnderLineColor(int layoutUnderLineColor) {
        this.layoutUnderLineColor = layoutUnderLineColor;
        invalidate();
    }
