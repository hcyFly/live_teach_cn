...
public class Constants {
	...
	public static final int AVIMCMD_ENTER_LIVE = 1;          // 用户加入直播
	public static final int AVIMCMD_EXIT_LIVE = 2;         // 用户退出直播,
	public static final int AVIMCMD_PRAISE = 3;           // 点赞消息,
	public static final int AVIMCMD_HOST_LEAVE = 4;         // 主播离开,
	public static final int AVIMCMD_HOST_BACK = 5;         // 主播回来,
